...
<body>
	...
	<div class="container" >
		<div class="row">
			<div class="col s12">
				<div class="row">
					<h3 class="grey-text text-darken-3">Daftar Lowongan Asisten <small><span style="color:#ff4d4d; font-style:italic;">(mahasiswa)</small></h3>
				</div>
				<table class="highlight">
					<thead>
					  <tr>
						  ...
						  <th data-field="Pengajar">Dosen Pengajar</th>
						  <th data-field="Status Lowongan">Status Lowongan</th>
					...
					<tbody>
					  ...
					  <tr>
						...
						<td>2</td>
						<td>Melamar</td>
						<td><a href=""><a class="waves-effect waves-light btn-large">Tambah</a></a></td>
					  </tr>
					  ...
					  <tr>
						...
						<td>0</td>						
						<td></td>
						<td><a class="waves-effect waves-light btn-large">Tambah</a></a></td>
					  </tr>
					</tbody>
				</table>
