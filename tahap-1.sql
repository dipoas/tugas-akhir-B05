...
(
	...
	FOREIGN KEY (IDKelasMK) REFERENCES KELAS_MK(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
	...
	FOREIGN KEY (IDKelasMK) REFERENCES KELAS_MK(ID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (Kode_MK) REFERENCES KELAS_MK(KodeMK) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (NIP) REFERENCES DOSEN(NIP) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
	...
	PRIMARY KEY (IDLog),
	FOREIGN KEY (IDLamaran) REFERENCES LAMARAN(IDLamaran) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (NPM) REFERENCES MAHASISWA(NPM) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (ID_kat_log) REFERENCES KATEGORI_LOG(ID) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (ID_st_log) REFERENCES STATUS_LOG ON DELETE CASCADE ON UPDATE CASCADE
);
