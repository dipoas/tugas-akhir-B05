...
(
	NPM CHAR(10) PRIMARY KEY NOT NULL REFERENCES MAHASISWA(NPM) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
	...
	/*NPM hanya perlu mengambil ke table LAMARAN, tidak perlu ke table MAHASISWA??*/
